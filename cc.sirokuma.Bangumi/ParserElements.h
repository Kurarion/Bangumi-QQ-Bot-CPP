...
//************
//不需要size_t类型的参数的命令
const static std::set<BgmCode> instruct_no_need_int{ BgmCode::BGM ,BgmCode::TML,BgmCode::User,BgmCode::Tag, BgmCode::Search,BgmCode::Statis/*,"!"*/ };
//需要string类型参数的命令
...
const static std::map<BgmCode, std::function<void (const bangumi::BGMCodeParam &, const std::set<size_t>&, const std::set<std::string>&)> >instruct_func_map
{
	...
	{ BgmCode::BGM, std::cref(bangumi::BGM_User_Collection) },
